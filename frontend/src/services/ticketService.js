...
export const ticketService = {
    ...
    // Obtener las áreas corporativas (/areas)
    getAreas: async () => {
    ...
    // Obtener la lista de usuarios para asignaciones y clientes
    getUsers: async () => {
    ...
    // Obtener la lista de usuarios para asignaciones y clientes
    getStaleTickets: async () => {
        const response = await api.get('/tickets/stale');
        return response.data;
    },
};